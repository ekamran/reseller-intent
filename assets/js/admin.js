...
(function() {
	 ...
	 */
	var MARK_PATH = 'M0.000,40.172 L0.000,19.578 C0.000,16.136 1.836,12.956 4.817,11.235 C9.510,8.526 16.603,4.430 21.295,1.721 C24.276,0.000 27.949,0.000 30.930,1.721 C35.622,4.430 42.716,8.526 47.408,11.235 C50.389,12.956 52.225,16.136 52.225,19.578 L52.225,38.606 C52.225,42.048 50.389,45.228 47.408,46.949 C42.716,49.658 35.622,53.754 30.930,56.463 C27.949,58.184 24.276,58.184 21.295,56.463 C14.645,52.623 3.461,46.166 3.461,46.166 L22.652,35.086 L22.652,44.991 L29.573,44.991 L29.573,35.086 L38.151,40.038 L41.612,34.044 L33.034,29.092 L41.612,24.140 L38.151,18.146 L29.573,23.098 L29.573,13.193 L22.652,13.193 L22.652,23.098 L14.074,18.146 L10.614,24.140 L19.191,29.092 L0.000,40.172 Z';

	function BrandMark() {
		return el('span', { className: 'ri-mark', 'aria-hidden': 'true' },
			el('svg', { viewBox: '0 0 52.225 58.184', width: 16, height: 18 },
				el('path', { fill: '#fff', fillRule: 'evenodd', d: MARK_PATH })
			)
		);
	}
